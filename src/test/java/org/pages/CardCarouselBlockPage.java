...
public class CardCarouselBlockPage extends Base{

	@FindBy(xpath="(//img[@alt='Beazley Logo'])[2]")
	private WebElement beazleyLogoCarouselBlock;
	...
	private String cardcarouselblock ="//div[@class='block cardcarouselblockmodel']//div//div//h2";
	
	//ul[@data-testid='headerBlockMainNavItems']//li//a[@data-ga-param-click-text='Claims']
	
	public CardCarouselBlockPage(WebDriver driver)
	{
	...
	{
		return beazleyLogoCarouselBlock.isDisplayed();
	}
...
//			    extentTest.log(LogStatus.PASS,itr.next().getText());
			}
		...
		if (urlvalue == true) {
			extentTest.log(LogStatus.PASS,"Footer section - Social links- URL Text validation: -Actual value: ----" + UIlink	+ "Expected value: -----" + ExpectedURL1 + "   . URL Values Matched!");
		}
...
//		solicallinknavig(driver);
	...
	public void solicallinknavig(WebDriver driver) throws InterruptedException{
        ...
        { 
            ...
            extentTest.log(LogStatus.PASS,driver.getTitle());
            Thread.sleep(50);
...
//			ArrayList<String> ArrayList1 = new ArrayList<String>();
		...
		if (boolval == true) {
			extentTest.log(LogStatus.PASS,"Header section - Location dropdown validation: -Actual value: ----" + firstList
...
//			ArrayList<String> ArrayList1 = new ArrayList<String>();
		...
		System.out.println(boolval);
		if (boolval == true) {
			extentTest.log(LogStatus.PASS,"Footer section - Location dropdown validation: -Actual value: ----" + firstList
					+ "Expected value: -----" + secondList + "   . Location Values Matched!");
		}
	}
...
//		checkpageload500error(driver);
		...
		extentTest.log(LogStatus.PASS,"In Footer Section - Beazley logo navigation Success! Page landed in 'https://www.beazley.com/en-us' ");
		driver.navigate().back();
		ScrollToFooter(driver);
	}
	...
	public void VerifyFootersectionSecondaryBlocklinkNavigation(WebDriver driver) throws InterruptedException {
		...
		if(url.equalsIgnoreCase("https://www.beazley.com/en-us"))
		extentTest.log(LogStatus.PASS,"In Footer Section - Privacy & Cookies link  navigation Success! Page landed in 'https://www.beazley.com/en-us' ");
		driver.navigate().back();
		ScrollToFooter(driver);
		...
		if(url.equalsIgnoreCase("https://www.beazley.com/en-us"))
		extentTest.log(LogStatus.PASS,"In Footer Section - Legal Information Link navigation Success! Page landed in 'https://www.beazley.com/en-us' ");
		driver.navigate().back();
		ScrollToFooter(driver);
		...
		if(url.equalsIgnoreCase("https://www.beazley.com/en-us"))
		extentTest.log(LogStatus.PASS,"In Footer Section - Modern Slavery Link  navigation Success! Page landed in 'https://www.beazley.com/en-us' ");
		Thread.sleep(5000);
		driver.navigate().back();
		ScrollToFooter(driver);
		...
		extentTest.log(LogStatus.PASS,"In Footer Section - Hp UAT link navigation Failed! Page landed in '500 Page data error' ");
		driver.navigate().back();
		ScrollToFooter(driver);
		extentTest.log(LogStatus.PASS,"************** Footer - Secondary  Block Links - Display & Navigation - Validaiton Compelted! ");
	...
	public void VerifyFootersectionPrimaryBlocklinkNavigation(WebDriver driver) throws InterruptedException {
		...
		String url = driver.getCurrentUrl();	
		if(url.equalsIgnoreCase("https://www.beazley.com/en-us"))
		extentTest.log(LogStatus.PASS,"In Footer Section - Investor Relations link  navigation Success! Page landed in 'https://www.beazley.com/en-us' ");
		driver.navigate().back();
		ScrollToFooter(driver);
		
		FooterWebelementDisplay_Navigation(driver, careers,"In Footer Section - Clicked on 'Careers' link & Link Navigaiton verified!");
		if(url.equalsIgnoreCase("https://www.beazley.com/en-us"))
		extentTest.log(LogStatus.PASS,"In Footer Section - Careers  Link navigation Success! Page landed in 'https://www.beazley.com/en-us' ");
		driver.navigate().back();
		ScrollToFooter(driver);
		...
		if(url.equalsIgnoreCase("https://www.beazley.com/en-us"))
		extentTest.log(LogStatus.PASS,"In Footer Section - Contact Us Link  navigation Success! Page landed in 'https://www.beazley.com/en-us' ");
		driver.navigate().back();
		ScrollToFooter(driver);
		
		FooterWebelementDisplay_Navigation(driver, link4,"In Footer Section - Clicked on 'Link 4' link & Link Navigaiton verified!");
		if(url.equalsIgnoreCase("https://www.beazley.com/en-us"))
		extentTest.log(LogStatus.PASS,"In Footer Section - 'Link 4' Link  navigation Success! Page landed in 'https://www.beazley.com/en-us' ");
		driver.navigate().back();
		ScrollToFooter(driver);
		
		FooterWebelementDisplay_Navigation(driver, link5,"In Footer Section - Clicked on 'Link 5' link & Link Navigaiton verified!");
		if(url.equalsIgnoreCase("https://www.beazley.com/en-us"))
		extentTest.log(LogStatus.PASS,"In Footer Section - Link 5 Link  navigation Success! Page landed in 'https://www.beazley.com/en-us' ");
		driver.navigate().back();
		ScrollToFooter(driver);
...
//		checkpageload404error(driver);
		...
		driver.navigate().back();
		ScrollToFooter(driver);
		extentTest.log(LogStatus.PASS,"************** Footer - Primary Block Links - Display & Navigation - Validaiton Compelted! ");
...
//		HeaderElementDisplayandTextvalidation(headerbeazleylogo, "");
	...
	public void VerifyCardCarouselBlockDisplayandHeaderTextOfEachCards(WebDriver driver) {
		
		CardCarouselBlock(driver,cardcarouselblock );
	}
...
//		        fail("500 page displayed! Failing test, and quitting.");
				extentTest.log(LogStatus.PASS,"!!!!!!!!!   Error LogType: Error Log message: Failed to request pageData from API, check the request URL ");
		}
	...
	public boolean isTextMatched(WebElement UIelement, String Expected) {
		...
		try {
			...
			extentTest.log(LogStatus.PASS,"verifytext  "+UIelement.getText()+":  "+verifytext);
			extentTest.log(LogStatus.PASS,"actual text: "+UIelement.getText());
			extentTest.log(LogStatus.PASS,"actual text: "+Expected);
	...
	public boolean BrowserNetworkError() {
	...
	public void checkpageload404error(WebDriver driver) {
		...
		extentTest.log(LogStatus.PASS,new Date(entry.getTimestamp()) + " " + entry.getLevel() + " " + entry.getMessage());
		String errorLogType= entry.getLevel().toString();
		String errorLog= entry.getMessage().toString();
		if(errorLog.contains("404")){
		extentTest.log(LogStatus.PASS,"!!!!!!!!!   Error LogType: "+ errorLogType+" Error Log message: "+errorLog);
//		fail("Error LogType: "+ errorLogType+" Error Log message: "+errorLog);
	...
	public Object FooterWebelementDisplay_Navigation(WebDriver driver, WebElement ele, String desc) throws InterruptedException{
		...
		if (display == true) {
			extentTest.log(LogStatus.PASS,display + "! " + desc);
		} else {
			extentTest.log(LogStatus.PASS,ele + "- NO ! Element is not Present");
		}
		extentTest.log(LogStatus.PASS,"Click to Action on " + ele.getText()+ "- Success!");
		ele.click();
...
//		checkpageload404error(driver);
	...
	public void CardCarouselBlock(WebDriver driver, String webelement) {
		...
		while (itr.hasNext()) {
			    extentTest.log(LogStatus.PASS,"CardCarouselBlock Heading: "+itr.next().getText());
	...
	public WebElement FooterElementDisplayandTextvalidation(WebElement ele, String ExpectedWebElementTextDescription) {
		boolean display = isDisplayed(ele);
		if (display == true) {
			extentTest.log(LogStatus.PASS,"Yes ! Element is Present :" + display);
			String ActualText=ele.getText();
			if(ActualText.equals(ExpectedWebElementTextDescription))
				extentTest.log(LogStatus.PASS,"Validated - '"+ ActualText+ "' text Display");
